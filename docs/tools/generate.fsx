...
#load "../../packages/FSharp.Formatting.2.14.2/FSharp.Formatting.fsx"
#I "../../packages/FAKE.4.27.0/tools/"
#r "FakeLib.dll"
open Fake
open System.IO
...
let formatting = __SOURCE_DIRECTORY__ @@ "../../packages/FSharp.Formatting.2.14.2/"
